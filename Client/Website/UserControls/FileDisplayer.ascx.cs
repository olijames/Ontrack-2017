...
{
    public partial class FileDisplayer : UserControlBase
    {
        ...
        protected void btnDelete_Click(object sender, EventArgs e)
        {
            ...
            DOJobFile JobFile = ParentPage.CurrentBRJob.SelectJobFileByFileID(FileID);

            if (JobFile != null)
                ParentPage.CurrentBRJob.DeleteJobFile(JobFile);
            if (RemoveFile != null)
