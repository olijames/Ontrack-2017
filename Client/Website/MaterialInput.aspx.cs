...
namespace Electracraft.Client.Website
{
    ...
    public partial class MaterialInput : PageBase
    {
        ...
        protected void LoadTitle()
        {
            ...
            string TID = "48C0380A-C3C2-454D-87A4-805A711A3A26"; //jared to add current task id


            DOBase DOBt = CurrentBRJob.SelectTask(Guid.Parse(TID));
            ...
            lblTitle.Text = dojc.JobNumberAuto + "-" + DOt.TaskNumber + ": " + DOt.TaskName + ", (" + DOj.Name + ")";
                ...
                foreach (GridViewRow gvChildRow in gvChild.Rows)
                {
                    ...
                    else//SET PROPERTIES OF UnEDITABLE CELLS
                    {
                        ...
                        if (VID != "00000000-0000-0000-0000-000000000000")
                        {
                            ...
                            DOBase a = CurrentBRJob.SelectVehicleByVehicleID(Guid.Parse("08F88AD1-7960-4F57-A899-94BF89792EBD")); //jared to provide logged in id
        ...
        protected void LoadgvMainUnassigned()//Load list for gvMain
        {
            ...
            //WORKING 
            List<DOBase> AllSupplierInvoicesUnAssigned = CurrentBRJob.SelectSupplierInvoicesOrderByCRef(Guid.Parse("ECA7B55C-3971-41DA-8E84-A50DA10DD233"), "0");//electracraft id
