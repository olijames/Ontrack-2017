...
<asp:Content ID="Content4" ContentPlaceHolderID="ContentBody" runat="server">
        ...
        <div class="row">
            <div class="small-12 columns">
                <h2>
                    ...
                    <span style="font-size: 0.9em;"><%# dojc.JobNumberAuto %> <%# Job.Name %> </span>
                    ...
                    &nbsp;<span style="font-size: 0.9em;">(<%# dojc.JobNumberAuto %>) <%# Job.Name %> </span><%--&nbsp;&nbsp;<span style="font-size: 0.7em; font-weight: normal;">(<%# CurrentSessionContext.CurrentCustomer.DisplayName %> - <%# CurrentSessionContext.CurrentSite.Address1 %>)</span>--%>
    ...
    <div class="row section">
        <div class="small-12 columns">
            <h2>Tasks <asp:Label ID="info" runat="server" Text="info" /></h2>
        </div>
    </div>
    ...
    <div class="row section" style="margin-top: 1em;">
        <div class="small-12 columns">
            <h2>Contractors linked to this job><asp:Panel ID="pnlNoContractors" runat="server">
